...
import { Home, Calendar, TrendingUp, MessageSquare, Settings, Menu, X } from 'lucide-react';
...
const patientNavItems = [
  ...
  { icon: Calendar, label: 'Sessions', path: '/patient/sessions' },
  { icon: TrendingUp, label: 'Progress', path: '/patient/progress' },
...
export function usePatientSidebarWidth() {
